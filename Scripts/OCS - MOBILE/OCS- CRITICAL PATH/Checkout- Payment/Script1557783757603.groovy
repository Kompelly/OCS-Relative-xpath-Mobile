...
WebUI.click(findTestObject('OCS-MOBILE /Payment -page/Change link span 1'))

WebUI.executeJavaScript('var previewBar = document.getElementById("preview-bar-iframe"); previewBar.style.display = "none";', 
    [])

WebUI.setViewPortSize(360, 1000, FailureHandling.CONTINUE_ON_FAILURE)
...
WebUI.click(findTestObject('OCS-MOBILE /Payment -page/Change link span 2'))
