...
WebUI.click(findTestObject('OCS-MOBILE /Cart flyout/Up Chevron - Accessories you might need'))

WebUI.delay(4)

WebUI.click(findTestObject('OCS-MOBILE /Cart flyout/Down Chevron - Accessories you might need'))
