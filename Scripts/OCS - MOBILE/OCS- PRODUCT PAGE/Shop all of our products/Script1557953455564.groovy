...
not_run: WebUI.scrollToElement(findTestObject('OCS-MOBILE /Product page/Recently Viewed/1st Product - Image'), 2)

WebUI.delay(1, FailureHandling.OPTIONAL)

WebUI.click(findTestObject('OCS-MOBILE /Product page/Shop all of our products - Button'))
