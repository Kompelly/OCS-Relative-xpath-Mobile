...
WebUI.selectOptionByValue(findTestObject('OCS-MOBILE /Age gate and Mega menu/Year Dropdown'), '2017', true)
...
WebUI.click(findTestObject('OCS-MOBILE /Age gate and Mega menu/Oops Im actually 19 or older - Link'))

WebUI.selectOptionByValue(findTestObject('OCS-MOBILE /Age gate and burger menu/Date'), '5', true)

WebUI.selectOptionByValue(findTestObject('OCS-MOBILE /Age gate and burger menu/month'), '6', true)

WebUI.selectOptionByValue(findTestObject('OCS-MOBILE /Age gate and Mega menu/Year Dropdown'), '1970', true)
