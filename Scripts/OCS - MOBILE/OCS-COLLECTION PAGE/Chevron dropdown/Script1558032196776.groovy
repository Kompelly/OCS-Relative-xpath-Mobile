...
WebUI.click(findTestObject('OCS-MOBILE /Collection page/dropdown'))

WebUI.delay(2)

boolean flag = WebUI.verifyElementPresent(findTestObject('OCS-MOBILE /Collection page/element inside'), 0)

WebUI.comment('flag=' + flag)

if (flag == true)
 {
    String a = WebUI.getText(findTestObject('OCS-MOBILE /Collection page/print element inside'))
